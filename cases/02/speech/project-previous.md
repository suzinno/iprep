...
8. I rejected row-level security deliberately — through a pooled connection it works only if every read sets the tenant inside its own transaction.
